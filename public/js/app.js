...
(function() {
  angular.module('Yachts').controller('LoginCtrl', function($scope, $http) {
...
(function() {
  angular.module('Yachts').directive('ngCounter', function($timeout) {
    return {
      restrict: 'A',
...
(function() {
  angular.module('Yachts').directive('ngMulti', function() {
    return {
      restrict: 'E',
      replace: true,
      scope: {
...
(function() {
  angular.module('Yachts').directive('orderBy', function() {
    return {
      restrict: 'E',
      replace: true,
      scope: {
...
(function() {
  angular.module('Yachts').directive('plural', function() {
    return {
      restrict: 'E',
      scope: {
        count: '=',
...
(function() {
  angular.module('Yachts').directive('ngSelectNew', function() {
    return {
      restrict: 'E',
      replace: true,
      scope: {
...
(function() {
  angular.module('Yachts').directive('ngSelect', function() {
    return {
      restrict: 'E',
      replace: true,
      scope: {
...
(function() {
  angular.module('Yachts').value('Published', [
    {
      id: 0,
...
(function() {
  angular.module('Yachts').service('IndexService', function($rootScope) {
