       ...
       return {
           ...
           template : 	'<div class="ng-image-gallery img-move-dir-{{imgMoveDirection}}" ng-class="{inline:inline}">'+
                           ...
                           '<div ng-if="thumbnails && !inline" class="ng-image-gallery-thumbnails">'+
                               '<div class="thumb" ng-repeat="image in images" ng-click="methods.open($index)" ng-style="{ \'background-image\': \'url(\' + (image.thumbUrl || image.url) + \')\' }"  ng-attr-title="{{image.title || undefined}}">'+
                                    '<div class="glyphicon glyphicon-remove delete-photo" ng-click="PhotoService.delete($index)"></div>'+
                               '</div>'+
                           '</div>'+
           ...
           link : function(scope, elem, attr){
               ...
               **/
               ...
               // @custom
               scope.PhotoService = scope.$parent.PhotoService
